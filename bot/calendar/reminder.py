...
BOT_COMMANDS: List[Tuple[str, str]] = [
    ...
    ("ask", "Hỏi tài liệu đã index (RAG)"),
    ("query", "Truy vấn Supabase bằng tiếng Việt"),
    ("think", "Bật/tắt chế độ suy nghĩ từng bước"),
    ("clear", "Xoá lịch sử hội thoại"),
    ("tables", "Xem bảng/cột Supabase"),
    ("refresh", "Cập nhật cache schema"),
    ("rag_index", "Index Supabase Storage vào RAG"),
